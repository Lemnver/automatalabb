...
En stark funktionalitet hos \emph{bash} är dess kraftfulla förmåga att använda shellglobar för att matcha filnamn. Karaktären * används för att matcha alla karaktärer i en sträng.
